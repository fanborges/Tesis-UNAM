%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                         FORMATO DE TESIS  FES ACATLÁN, UNAM                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Nuevas modificaciones en este archivo por Luis C. Zúñiga.

%                     Under GNU License v3

% ADAPTADO PARA UMSNH:  @arturolp
% ADAPTADO PARA FES ACATLÁN: fanborges

\documentclass[twoside,11pt]{Latex/Classes/thesisFESAC}
...
%                                   DATOS                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Algún título largo e interesante de historia}
\author{Luis Clemente Zúñiga Flores} 
\facultad{Facultad de Estudios Superiores Acatlán.}                 % Nombre de la facultad/escuela
\escudofacultad{Latex/Classes/Escudos/fesa} % Aquí ponen la ruta y nombre del escudo de su facultad, actualmente, la carpeta Latex/Classes/Escudos cuenta con los siguientes escudos:
...
\degree{Licenciado en Historia}       % Carrera
\director{Marc Bloch}                   % Director de tesis
%\tutor{Nombre  Tutor }                    % Tutor de tesis, si aplica
\degreedate{2018}                                     % Año de la fecha del examen
\lugar{Santa Cruz Acatlán, Naucalpan}                        % Lugar
